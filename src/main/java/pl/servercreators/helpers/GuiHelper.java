...
public class GuiHelper {
    ...
    public void setItemFromConfig(Inventory inv, int slot, String guiName, String itemName,
                                        String targetName, NamespacedKey typeKey, String typeValue,
                                        NamespacedKey targetKey, String targetUUID) {
    ...
    public void fillBackground(Inventory inv, NamespacedKey typeKey, String typeValue) {
